        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="#" className="w-9 h-9 rounded-full bg-border flex items-center justify-center hover:bg-primary transition">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-textMuted">
              <li><a href="#" className="hover:text-primary transition">কেনাকাটা মার্কেটপ্লেস</a></li>
              <li><a href="#" className="hover:text-primary transition">ডাক্তার ও ক্লিনিক</a></li>
              <li><a href="#" className="hover:text-primary transition">রক্ত ডোনার খুঁজুন</a></li>
              <li><a href="#" className="hover:text-primary transition">লোকাল সার্ভিস</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-textMuted">
              ...
              <li><a href="#" className="hover:text-primary transition">যোগাযোগ</a></li>
              <li><a href="#" className="hover:text-primary transition">ক্যারিয়ার</a></li>
              <li><a href="#" className="hover:text-primary transition">মিডিয়া</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="https://play.google.com/store/apps/details?id=com.global.zilaseba" target="_blank" className="inline-block w-full">
                <div className="bg-black border border-gray-700 px-4 py-3 rounded-xl flex items-center gap-3 hover:bg-gray-900 transition">
                  ...
                  <div className="text-left">
                    <p className="text-[10px] text-gray-300 uppercase leading-tight">Get it on</p>
