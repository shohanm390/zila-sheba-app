...
// import brandLogo from "../image/brand-logo.png";

const Navbar = () => {
  return (
<header className="fixed top-0 w-[400px] md:w-full lg:w-full z-50 bg-[#040914]/80 backdrop-blur-md border-b border-border transition-all overflow-x-hidden">      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
