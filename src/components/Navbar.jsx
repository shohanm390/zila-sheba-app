...
import CitySelector from "./assets/CitySelector";
...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <nav className="hidden lg:flex items-center gap-7 text-sm font-medium text-textMuted h-full">
            ...
            <div className="relative group h-full flex items-center cursor-pointer">
              <div className="flex items-center gap-1 group-hover:text-white transition">
                <span>আয়করুন</span>
                <svg
                  className="w-4 h-4 text-textMuted group-hover:text-white transition-transform duration-300 group-hover:rotate-180"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <div className="absolute top-[100%] left-0 w-56 pt-2 opacity-0 invisible translate-y-3 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 z-50">
                <div className="bg-card/95 backdrop-blur-xl border border-border rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.4)] p-2 flex flex-col gap-1">
                  <a
                    href="#"
                    className="px-4 py-2.5 rounded-xl text-textMuted hover:text-white hover:bg-primary/10 transition flex justify-between items-center group/item"
                  >
                    রাইডার হোন{" "}
            ...
            <div className="relative group h-full flex items-center cursor-pointer">
              ...
              <div className="absolute top-[100%] left-1/2 -translate-x-1/2 w-64 pt-2 opacity-0 invisible translate-y-3 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 z-50">
                <div className="bg-card/95 backdrop-blur-xl border border-border rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.4)] p-2 grid grid-cols-1 gap-1">
                  <a
                    href="#"
                    className="px-4 py-3 rounded-xl hover:bg-cardHover transition flex items-center gap-3"
                  >
            ...
            <div className="relative group h-full flex items-center cursor-pointer">
              ...
              <div className="absolute top-[100%] left-1/2 -translate-x-1/2 w-48 pt-2 opacity-0 invisible translate-y-3 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 z-50">
                <div className="bg-card/95 backdrop-blur-xl border border-border rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.4)] p-2 flex flex-col gap-1 text-center">
                  <a
                    href="#"
                    className="px-4 py-2.5 rounded-xl text-textMuted hover:text-white hover:bg-cardHover transition"
                  >
                    কাস্টমার সাপোর্ট
                  </a>
                  <a
            ...
            <a
              href="#"
              className="hover:text-white transition flex items-center h-full relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all hover:after:w-full"
            >
              কেনা বেচা
            </a>
            <a
            ...
            <div className="relative group h-full flex items-center cursor-pointer">
              ...
              <div className="absolute top-[100%] right-0 w-48 pt-2 opacity-0 invisible translate-y-3 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 z-50">
                <div className="bg-card/95 backdrop-blur-xl border border-border rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.4)] p-2 flex flex-col gap-1">
                  <a
                    href="#"
                    className="px-4 py-2.5 rounded-xl text-textMuted hover:text-white hover:bg-cardHover transition flex justify-between items-center"
                  >
                    আমাদের সম্পর্কে
                  </a>
                  <a
                  ...
                  <a
                    href="#"
                    className="px-4 py-2.5 rounded-xl text-primary hover:bg-primary/10 bg-primary/5 transition flex justify-between items-center"
                  >
                    ক্যারিয়ার{" "}
      ...
      <div
        className={`fixed top-0 right-0 h-full w-[80%] max-w-sm bg-[#040914] border-l border-border z-40 lg:hidden transform transition-transform duration-300 overflow-y-auto flex flex-col pt-24 pb-6 ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        {/* Accordion 1: আয়করুন */}
        <div className="border-b border-border">
          <button
            onClick={() => toggleAccordion(1)}
            className="w-full flex items-center justify-between px-6 py-4 text-white font-medium hover:bg-card/50 transition"
          >
            <span>আয়করুন</span>
            <svg
              className={`w-4 h-4 transition-transform duration-300 ${activeAccordion === 1 ? "rotate-180 text-primary" : "text-textMuted"}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${activeAccordion === 1 ? "max-h-48 opacity-100" : "max-h-0 opacity-0"}`}
          >
            <div className="flex flex-col gap-1 px-6 pb-4 bg-card/20">
              <a
                href="#"
                className="py-2.5 text-sm text-textMuted hover:text-white transition"
              >
                রাইডার হোন
              </a>
              <a
        ...
        <div className="border-b border-border">
          ...
          >
            <span>সার্ভিসসমূহ</span>
            <svg
              className={`w-4 h-4 transition-transform duration-300 ${activeAccordion === 2 ? "rotate-180 text-primary" : "text-textMuted"}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${activeAccordion === 2 ? "max-h-80 opacity-100" : "max-h-0 opacity-0"}`}
          >
            <div className="flex flex-col gap-2 px-6 pb-4 bg-card/20">
              <a href="#" className="py-2 flex items-center gap-3 group">
                ...
                <div>
                  <h4 className="text-white font-medium text-sm group-hover:text-primary transition">
                    হোটেল ও রেস্টুরেন্ট
                  </h4>
                </div>
              </a>
        ...
        <div className="border-b border-border">
          ...
          >
            <span>হেল্প</span>
            <svg
              className={`w-4 h-4 transition-transform duration-300 ${activeAccordion === 3 ? "rotate-180 text-primary" : "text-textMuted"}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${activeAccordion === 3 ? "max-h-48 opacity-100" : "max-h-0 opacity-0"}`}
          >
            <div className="flex flex-col gap-1 px-6 pb-4 bg-card/20">
              <a
                href="#"
        ...
        <a
          href="#"
          className="px-6 py-4 text-white font-medium border-b border-border hover:bg-card/50 transition"
        >
          কেনা বেচা
        </a>
        <a
        ...
        <div className="border-b border-border">
          ...
          >
            ...
            <svg
              className={`w-4 h-4 transition-transform duration-300 ${activeAccordion === 4 ? "rotate-180 text-primary" : "text-textMuted"}`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div
            className={`overflow-hidden transition-all duration-300 ease-in-out ${activeAccordion === 4 ? "max-h-48 opacity-100" : "max-h-0 opacity-0"}`}
          >
            <div className="flex flex-col gap-1 px-6 pb-4 bg-card/20">
              <a
                href="#"
              ...
              <a
                href="#"
                className="py-2.5 text-sm text-primary transition flex items-center justify-between"
              >
                ক্যারিয়ার{" "}
                <span className="bg-red-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded">
                  NEW
        ...
        <div className="mt-auto px-6 pt-6 flex justify-between items-center lg:hidden">
